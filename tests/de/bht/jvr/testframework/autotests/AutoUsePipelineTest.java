...
public class AutoUsePipelineTest extends AbstractAutoTest{

    public AutoUsePipelineTest() {
        super("AutoUsePipelineTest");
    }
    ...
    public Pipeline getPipeline() throws Exception {
        ...
        // clear fbo buffers
        pipeline.clearBuffers(true, new boolean[] { true }, Color.gray);

        pipeline.switchCamera(camera);

        pipeline.usePipeline(renderP);
