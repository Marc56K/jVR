 ...
 */
public class NewtAwtMixTest extends TestBase {
    ...
    public NewtAwtMixTest() throws Exception {
        ...
        NewtRenderWindow win1 = new NewtRenderWindow(p, 800, 600);
        win1.addKeyListener(this);
        win1.addMouseListener(this);
        // win1.setVSync(false);
        // win1.setFSAA(2);
        win1.setPosition(5, 5);
        ...
        // win2.setVSync(false);
        // win2.setFSAA(2);
        win2.setPosition(820, 5);

        Viewer viewer = new Viewer(win2, win1);
