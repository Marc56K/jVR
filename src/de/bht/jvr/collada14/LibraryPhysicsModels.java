...
@XmlType(name = "", propOrder = { "asset", "physicsModels", "extras" })
...
public class LibraryPhysicsModels {
    ...
    /**
     * There must be at least one physics_model element. Gets the value of the
     * physicsModels property.
     * <p>
     * This accessor method returns a reference to the live list, not a
     * snapshot. Therefore any modification you make to the returned list will
     * be present inside the JAXB object. This is why there is not a
     * <CODE>set</CODE> method for the physicsModels property.
     * <p>
     * For example, to add a new item, do as follows:
     * 
     * <pre>
