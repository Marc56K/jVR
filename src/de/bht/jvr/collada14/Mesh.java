...
@XmlType(name = "", propOrder = { "sources", "vertices", "linesAndLinestripsAndPolygons", "extras" })
...
public class Mesh {
    ...
    @XmlElements({ @XmlElement(name = "trifans", type = Trifans.class),
    ...
    /**
     * The mesh element may contain any number of lines elements. Gets the value
     * of the linesAndLinestripsAndPolygons property.
     * <p>
     * This accessor method returns a reference to the live list, not a
     * snapshot. Therefore any modification you make to the returned list will
     * be present inside the JAXB object. This is why there is not a
     * <CODE>set</CODE> method for the linesAndLinestripsAndPolygons property.
     * <p>
     * For example, to add a new item, do as follows:
     * 
     * <pre>
     ...
     * </pre>
     * <p>
     * Objects of the following type(s) are allowed in the list {@link Trifans }
     * {@link Polylist } {@link Polygons } {@link Tristrips } {@link Linestrips }
     * {@link Lines } {@link Triangles }
     */
    public List<Object> getLinesAndLinestripsAndPolygons() {
        ...
        return linesAndLinestripsAndPolygons;
    }
     ...
     * 
     * @return possible object is {@link Vertices }
     */
     ...
     * 
     * @param value
     *            allowed object is {@link Vertices }
     */
