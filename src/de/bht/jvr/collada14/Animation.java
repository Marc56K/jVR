...
@XmlType(name = "", propOrder = { "asset", "sources", "samplers", "channels", "animations",
        "extras" })
...
public class Animation {
     ...
     * <CODE>set</CODE> method for the animations property.
     * <p>
    ...
    /**
     * The animation element may contain any number of channel elements. Gets
     ...
     * snapshot. Therefore any modification you make to the returned list will
     * be present inside the JAXB object. This is why there is not a
     * <CODE>set</CODE> method for the samplers property.
     * <p>
     * For example, to add a new item, do as follows:
     * 
     * <pre>
     ...
     * </pre>
     * <p>
     * Objects of the following type(s) are allowed in the list {@link Sampler }
     */
    ...
    /**
     * The animation element may contain any number of source elements. Gets the
