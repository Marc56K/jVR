...
@XmlType(name = "fx_surface_common", propOrder = { "initFroms", "initPlanar", "initVolume",
        "initCube", "initAsTarget", "initAsNull", "format", "formatHint", "viewportRatio", "size",
        "mipLevels", "mipmapGenerate", "extras" })
...
public class FxSurfaceCommon {
     ...
     * snapshot. Therefore any modification you make to the returned list will
     * be present inside the JAXB object. This is why there is not a
     * <CODE>set</CODE> method for the initFroms property.
     * <p>
     * For example, to add a new item, do as follows:
     * 
     * <pre>
     ...
     * snapshot. Therefore any modification you make to the returned list will
     * be present inside the JAXB object. This is why there is not a
     * <CODE>set</CODE> method for the viewportRatio property.
     * <p>
     * For example, to add a new item, do as follows:
     * 
     * <pre>
