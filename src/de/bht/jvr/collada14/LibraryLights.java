...
@XmlType(name = "", propOrder = { "asset", "lights", "extras" })
...
public class LibraryLights {
    ...
    /**
     * There must be at least one light element. Gets the value of the lights
     * property.
     * <p>
     * This accessor method returns a reference to the live list, not a
     * snapshot. Therefore any modification you make to the returned list will
     * be present inside the JAXB object. This is why there is not a
     * <CODE>set</CODE> method for the lights property.
     * <p>
     * For example, to add a new item, do as follows:
     * 
     * <pre>
     ...
     * </pre>
     * <p>
     * Objects of the following type(s) are allowed in the list {@link Light }
     */
