...
public enum FxSurfaceFormatHintRangeEnum {
    ...
    /**
     * Format is representing a decimal value that remains within the -1 to 1
     * range. Implimentation could be integer-fixedpoint or floats.
     */
    SNORM,

    /**
     * Format is representing a decimal value that remains within the 0 to 1
     * range. Implimentation could be integer-fixedpoint or floats.
     */
    UNORM,
    ...
    /**
     * Format should support full floating point ranges. High precision is
     * expected to be 32bit. Mid precision may be 16 to 32 bit. Low precision is
     * expected to be 16 bit.
     */
    FLOAT;
