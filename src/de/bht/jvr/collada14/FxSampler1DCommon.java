...
@XmlType(name = "fx_sampler1D_common", propOrder = { "source", "wrapS", "minfilter", "magfilter",
        "mipfilter", "borderColor", "mipmapMaxlevel", "mipmapBias", "extras" })
@XmlSeeAlso({ CgSampler1D.class, GlSampler1D.class })
