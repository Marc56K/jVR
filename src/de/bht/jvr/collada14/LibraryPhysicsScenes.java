...
@XmlType(name = "", propOrder = { "asset", "physicsScenes", "extras" })
...
public class LibraryPhysicsScenes {
    ...
    /**
     * There must be at least one physics_scene element. Gets the value of the
     * physicsScenes property.
     * <p>
     * This accessor method returns a reference to the live list, not a
     * snapshot. Therefore any modification you make to the returned list will
     * be present inside the JAXB object. This is why there is not a
     * <CODE>set</CODE> method for the physicsScenes property.
     * <p>
     * For example, to add a new item, do as follows:
     * 
     * <pre>
