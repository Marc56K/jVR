...
public class DeclareVariable implements PipelineCommand {
   
    private Variable var;
    
    public DeclareVariable(String name, Number value) {
        this.var = new Variable(name, value);
    }
    
    @Override
    public void execute(Context ctx, PipelineState pipelineState) throws Exception {
        pipelineState.registerVariable(var);        
    }
