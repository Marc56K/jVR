...
public class SwitchFrameBufferObject implements PipelineCommand {
    private String fboName;

    public SwitchFrameBufferObject(String fboName) {
        this.fboName = fboName;
    }

    @Override
    public void execute(Context ctx, PipelineState pipelineState) throws Exception {
        pipelineState.setActiveFbo(pipelineState.getFBO(fboName));
