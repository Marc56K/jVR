...
public class SetStencilOp implements PipelineCommand {
    private int[] stencilOp;

    public SetStencilOp(int fail, int zFail, int zPass) {
        stencilOp = new int[] { fail, zFail, zPass };
    }

    @Override
    public void execute(Context ctx, PipelineState pipelineState) throws Exception {
        pipelineState.setStencilOp(stencilOp.clone());
    }
