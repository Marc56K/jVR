...
public class ParallaxMappingExample implements MouseListener {
    /**
     * @param args
     */
    ...
    public ParallaxMappingExample() throws Exception {
        // load geometry
        ...
        cam.setTransform(Transform.translate(0, 0.5f, 1.75f)); // transform the camera
